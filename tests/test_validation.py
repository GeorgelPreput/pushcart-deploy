...
from pushcart_deploy.validation import validate_databricks_api_client
...
class TestValidateDatabricksApiClient:
    ...
    def test_invalid_url_or_default_headers(self, mocker):
        """
    ...
    def test_client_not_instance_of_ApiClient(self, mocker):
        """
